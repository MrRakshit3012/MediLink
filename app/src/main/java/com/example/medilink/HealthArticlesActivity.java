...
import com.example.medilink.R.id;
...
public class HealthArticlesActivity extends AppCompatActivity {
    ...
    Button btnBack; /*= findViewById(id.buttonHABack);*/
    ListView lst; /*= findViewById(id.ListViewHealthArticles);*/
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_health_articles);
         lst = findViewById(id.ListViewHealthArticles);
         btnBack=findViewById(id.buttonHABack);
